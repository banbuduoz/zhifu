	...
	<div class="container-fluid">
		...
		<div>
			<ul class="nav navbar-nav">
				<li><a href="http://localhost:8080/chinatobacco/index.html">首页</a></li>
				<li><a
					href="http://localhost:8080/chinatobacco/moneylist/list.do">查看流水</a></li>
				<li><a
					href="http://localhost:8080/chinatobacco/account/list.do">查看账户</a></li>
